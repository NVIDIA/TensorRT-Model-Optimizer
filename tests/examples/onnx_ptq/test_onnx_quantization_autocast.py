...
from _test_utils.onnx_path import ONNX_CONVIT_SMALL_OPSET17_PATH, ONNX_DISTILBERT_OPSET17_PATH
...
class OnnxAutocastTestRunner:
    ...
    def _run_trtexec_validation(self, model_path: str):
    ...
    def run_cli_test(
        ...
        self._run_trtexec_validation(output_path)
