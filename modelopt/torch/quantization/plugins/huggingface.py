...
def register_hf_attentions_on_the_fly(model):
    ...
    # For transformers version >= 4.48.0, we need to use the new method to register the attention class
    # For transformers version < 4.48.0, we use the legacy method to register the attention class
