...
def build_attention_config(
    ...
    config.k_cache_scaling_factor = get_kv_cache_scaling_factor(
        qkv_modules[0] if len(qkv_modules) == 1 else k
    )
    config.v_cache_scaling_factor = get_kv_cache_scaling_factor(
        qkv_modules[0] if len(qkv_modules) == 1 else v
    )
