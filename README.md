...
[![version](https://img.shields.io/badge/release-0.11.0-green)](<>)
...
- \[2024/05/06\] [Announcement: Model Optimizer Now Formally Available to Further Accelerate GenAI Inference Performance](https://developer.nvidia.com/blog/accelerate-generative-ai-inference-performance-with-nvidia-tensorrt-model-optimizer-now-publicly-available/)
...
Please see Model Optimizer Changelog in [doc](https://nvidia.github.io/TensorRT-Model-Optimizer).
