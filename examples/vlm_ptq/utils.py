...
def parse_arguments(occasion):
    ...
    parser.add_argument(
        ...
        help="Maximum number of new tokens generated by LLM",
    )
    ...
    parser.add_argument(
        "--input_text", type=str, default=None, help="Text prompt to LLM, separated by symbol"
    )
    ...
    parser.add_argument(
        ...
        default=0.5,
        type=float,
        help="Specify the kv cache fraction reserved for cross attention. Only "
        "applicable for encoder-decoder models. By default 0.5 for self and 0.5 for cross.",
    )
    parser.add_argument(
        "--multi_block_mode",
